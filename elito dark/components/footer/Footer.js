                        ...
                        <div className="col col-lg-3 col-md-6 col-12">
                            <div className="widget link-widget service-link-widget">
                                ...
                                <ul>
                                    ...
                                    <li><Link to="service" spy={true} smooth={true}  duration={500}>Software Testing</Link></li>
                                </ul>
                            </div>
                        </div>
                        <div className="col col-lg-3 col-md-6 col-12">
            ...
            <div className="lower-footer">
                <div className="container">
                    <div className="row">
                        ...
                        <p className="copyright">Copyright &copy; 2025 Ayush Kumar. All rights reserved.</p>
                    </div>
                </div>
            </div>
        </footer>
