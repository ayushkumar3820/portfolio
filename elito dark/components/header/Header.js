                            ...
                            <div className="col-lg-2 col-md-6 col-6">
                                <div className="navbar-header">
                                    <Link onClick={ClickHandler} className="navbar-brand site-logo" href="/"><img
                                        src="images/logo.png" alt="" />kumar.</Link>
                                </div>
                            </div>
                            <div className="col-lg-8 col-md-2 col-2">
                            ...
                            <div className="col-lg-2 col-md-2 col-2">
                                <div className="header-right">
                                    <div className="header-btn">
                                        <a onClick={ClickHandler} className="theme-btn" download="My Cv" href="images/Ayush.pdf"
                                            title="ImageName">
                                            <img className="hide-img" alt="ImageName" src="images/Ayush.pdf" />
                                            Resume
                                        </a>
                                    </div>
                                </div>
