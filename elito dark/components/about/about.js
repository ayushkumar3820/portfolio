                    ...
                    <div className="col-lg-5 col-md-12 col-sm-12">
                        <div className="wpo-about-exprience-wrap">
                            ...
                            <div className="client">
                                <h3><span data-count="100">90</span>%</h3>
                    ...
                    <div className="col-lg-6 offset-lg-1 col-md-12 col-sm-12">
                        <div className="wpo-about-content">
                            <div className="wpo-about-title">
                                <h2>My Advantage</h2>
                                <p>I build scalable full-stack solutions with MongoDB, Express, React, and Node.js, 
                                    turning complex ideas into user-friendly systems.</p>
                            </div>
                            <div className="wpo-about-funfact">
                                ...
                                <div className="grid">
                                    <div className="grid-inner">
                                        <h3><span data-count="43">83</span>%</h3>
                                        <p>MongoDB</p>
                                    </div>
                                </div>
                                <div className="grid">
                                    <div className="grid-inner">
                                        <h3><span data-count="37">79</span>%</h3>
                                        <p>PostgreSql</p>
                                    </div>
                                </div>
                            </div>
