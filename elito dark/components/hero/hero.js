                        ...
                        <div className="row align-items-center">
                            <div className="col-xl-6 col-lg-6 col-12">
                                ...
                                <div data-swiper-parallax="500" className="slide-title">
                                        <h1>
                                            <span style={{ color: '#FFD700',fontSize:"80px" }}>Hello,</span>
                                            <Typewriter
                                                options={{
                                                    strings: ["I Am Ayush Kumar"],
                                                    autoStart: true,
                                                    loop: true,
                                                    delay: 170,
                                                    deleteSpeed: 50,
            ...
            <div className="static-hero-right">
                <div className="static-hero-img">
                    <div className="static-hero-img-inner">
                        ...
                        <div className="icon-1 floating-item"><img src='images/icon/node-js-icon.svg' alt="" /></div>
                        <div className="icon-2 floating-item"><img src='images/icon/illustrator.svg' alt="" /></div>
                        <div className="icon-3 floating-item"><img src='images/icon/postgresql-logo-svgrepo-com.svg' alt="" /></div>
                        <div className="project floating-item">
                            <div className="icon">
                                <i className="fi flaticon-verified"></i>
                            </div>
                            <div className="p-text">
                                <h3><span data-count="1500">15</span>+</h3>
